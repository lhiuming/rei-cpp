...
// Set draw function
void GLRenderer::set_draw_func(DrawFunc lambda_object)
{
...
void
GLRenderer::rasterize_triangle(const Mesh::Triangle& tri, const Mat4& trans)
{
...
inline void GLRenderer::put_sample(int x, int y)
{
